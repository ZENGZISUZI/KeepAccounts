...
// *
// */
//public class Month_LineChartFragment extends BaseFragment {
...
//
//    float max=100;//  y轴最高
//    public Month_LineChartFragment() {
//    }
//
//    @Override
...
//            );*/ try {
//                List<Account> acountList =db.selector(Account.class).where("date", "=", date).and("type","=",1).findAll();
//                int j = 0;
...
//            try {
//                List<Account> acountList =db.selector(Account.class).where("date", "=", date).and("type","=",0).findAll();
//                int j = 0;
//                for (int t =0; t < acountList.size(); t++) {
//                    values.add(new PointValue(j, acountList.get(t).getFigure()));
//                    if(acountList.get(t).getFigure()>max)
