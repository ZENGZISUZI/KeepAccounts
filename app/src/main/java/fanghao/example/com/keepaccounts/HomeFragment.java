...
public class HomeFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        float Sum=0;
        try {
            Cursor cur = db.execQuery("select total(figure) from acounts where type='0'");
            if (cur!=null)
            {
                if (cur.moveToFirst())
                {
             ...
             cur = db.execQuery("select total(figure) from acounts where type='1'");
            if (cur!=null)
            {
                if (cur.moveToFirst())
                {
...
//            Sum=addSum+descSum;
            ...
            acount.setRemarks("测试");
            acount.setCategory("测试");
            acount.setDate("测试");
            acount.setFigure(0);
            acount.setType("测试");
            try {
                db.save(acount);
                db.delete(Acount.class);
